...
function Home() {
  ...
  const handleInputChange = (e) => {
    ...
    setFormData((prevData) => ({
      ...prevData,
      [name]: value,
      // password: value, // Assuming you want to update the 'password' property with the same value as well
    }));
  };
        ...
        <div className="bg-white shadow-md md:w-2/6 flex flex-col py-10 px-5  m-auto w-4/5">
          ...
          <form className="w-full px-5">
            <input
              ...
              className="border-b w-full border-b-gray-700 text-sm py-2 focus:outline-none "
            />
            ...
            <div>
              <button
                ...
                className="bg-blue-600 px-10 py-2 float-right my-5 text-sm text-white"
        ...
        <div className="bg-white shadow-md md:w-2/6  flex flex-col py-10 px-5  m-auto w-4/5">
          ...
          <form onSubmit={() => signIn(event)} className="w-full px-5">
            <input
              ...
              value={''}
              placeholder="Email, phone or skype"
              className="border-b w-full border-b-gray-700 text-sm py-2 focus:outline-none focus:border-b-blue-700"
            />
            <input
              type="password"
            ...
            <div>
              ...
              >
                {loading ? (
                  <>
                    verifying <ClipLoader color="white" size={10} />{' '}
                  </>
                ) : (
                  'Sign in'
                )}
